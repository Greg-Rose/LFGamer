...
var newLfgCreator = function(lfgAttributes) {
  return {
    lfg: lfgAttributes,
    create: lfgCreatorCreate,
    updateForm: lfgCreatorUpdateForm,
    showLfgsList: lfgCreatorShowLfgsList
  };
};

var lfgCreatorCreate = function() {
...
var lfgCreatorUpdateForm = function(json) {
...
var lfgCreatorShowLfgsList = function(json) {
